---
title: "[Spring Boot에서 캐시(Cache) 활용하기] - 캐시 적용"
date: 2025-05-07 21:00:00 +0900
categories: [Spring]
tags: [spring, cache]
image:
  path: /assets/img/posts/2025-05-08-using-cache-02/01.png
---
...
### 기능 구현
> Base 프로젝트의 전체 코드는 [Github](https://github.com/tjvm0877/blog-code/tree/main/using-cache/base-project)에 있으니 참고해주세요.
{: .prompt-info }
...
---
> 프로젝트에 캐시가 적용 전체 코드는 [Github](https://github.com/tjvm0877/blog-code/tree/main/using-cache/apply-local-cache)에 있으니 참고해주세요.
{: .prompt-info }
